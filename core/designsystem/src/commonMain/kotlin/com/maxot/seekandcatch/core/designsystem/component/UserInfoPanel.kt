...
fun UserInfoPanel(
    ...
    PixelBorderBox(
        ...
        Column(modifier = Modifier.padding(10.dp)) {
            Text(
                text = stringResource(Res.string.feature_account_your_info),
                modifier = Modifier
                    .padding(5.dp)
            )
            ...
            Row(
                ...
                Text(
                    text = stringResource(Res.string.feature_account_user_id_title),
            ...
            Row(
                ...
                TextField(
                    ...
                    label = {
                        Text(stringResource(Res.string.feature_account_user_name_title))
                    })
