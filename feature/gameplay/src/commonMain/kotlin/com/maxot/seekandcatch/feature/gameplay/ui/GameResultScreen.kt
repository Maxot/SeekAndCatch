...
private fun GameResultScreenBody(
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            Text(
                text = stringResource(
                    Res.string.feature_gameplay_label_score,
                    uiState.lastScore
                ),
            ...
            if (!uiState.isNewBest) {
                Text(
                    text = stringResource(
                        Res.string.feature_gameplay_label_your_best_score,
            ...
            uiState.rank?.let { rank ->
                Text(
                    text = stringResource(
                        Res.string.feature_gameplay_label_rank,
                        rank
                    ),
                    textAlign = TextAlign.Center,
                    style = MaterialTheme.typography.titleLarge,
            ...
            PixelButton(
                ...
                Text(
                    text = stringResource(Res.string.feature_gameplay_button_restart),
                    textAlign = TextAlign.Center,
            ...
            PixelButton(
                ...
                Text(
                    text = stringResource(
                        Res.string.feature_gameplay_button_to_main_screen,
                        uiState.lastScore
                    ),
                    textAlign = TextAlign.Center,
                    color = MaterialTheme.colorScheme.onPrimary,
